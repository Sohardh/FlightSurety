...
contract FlightSuretyData {
    ...
    function isInsured(
        ...
        uint256 timestamp
            ...
            Insurance[] memory insuredPassengers
         = insuredPassengersPerFlight[getFlightKey(airline, flight, timestamp)];
    ...
    function processFlightStatus(
        ...
        if (flights[flightKey].statusCode == STATUS_UNKNOWN) {
            flights[flightKey].statusCode = statusCode;
            if (statusCode == STATUS_LATE_AIRLINE) {
    ...
    function creditInsurees(
        ...
        for (
            ...
            i++
             ...
             = insuredPassengersPerFlight[flightKey][i];
